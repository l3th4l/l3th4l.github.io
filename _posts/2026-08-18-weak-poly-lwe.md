...
1. $q$ must be a prime such that $f(x)$ factorizes completely modulo $q$. 
	...
	*Example 1:* Let's take $f(x) =  x^2 + 603$ and the prime $q =  151$. By itself, $f(x)$ cannot be reduced into factors $c(x), d(x)$ such that $f(x) = c(x)d(x)$. 
	But when we take $f(x) \mod 151$, we get $$f(x) \equiv x^2 + 150 \mod 151$$
	Which factorizes into $$f(x) \equiv (x + 1) (x + 150) \mod 151$$
	Let's verify this. $$f(x)\equiv x^2 + x + 150x + 150 \mod 151$$ $$\equiv x^2 + 151x + 150   \mod 151 \equiv x^2 + 150 \mod151$$  
